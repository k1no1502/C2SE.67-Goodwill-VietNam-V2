...
<head>
    ...
    <style>
        ...
        .hours-action-btn.approve {
            background-color: #198754;
        }
        .hours-action-btn.reject {
                                            ...
                                            <td>
                                                <div class="hours-action-group">
                                                    <form method="POST">
                                                        ...
                                                        <button class="hours-action-btn approve" type="submit" title="Approve">
                                                    ...
                                                    <form method="POST">
                                                        ...
                                                        <input type="hidden" name="log_id" value="<?php echo (int)$log['log_id']; ?>">
                                                        <button class="hours-action-btn reject" type="submit" title="Reject">
                                                            <i class="bi bi-x"></i>
                                                        </button>
                                                    </form>
                                                </div>
